steal('can/util', 'can/list', function (can) {
	...
	can.extend(proto, {
		 ...
		 * @hide
		 */
		sort: function (comparatorFn, silent) {
			var a, b, c, isSorted;

			// Allow the user to override the list's default comparator function
			comparatorFn = comparatorFn ? comparatorFn : this._comparator;
